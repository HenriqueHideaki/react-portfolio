...
export default function Contact() {
  ...
  const contacts = [
    {
      name: "WhatsApp",
      description: "+55 84 99115-7374",
      link: "https://api.whatsapp.com/send?phone=5584991157374.",
      icon: <FaWhatsapp className="h-10 w-10" />,
    },
    {
      name: "Email",
      description: "hideakikoga.hk@gmail.com",
      link: "mailto:hideakikoga.hk@gmail.com?subject=Olá...",
      icon: <HiOutlineEnvelope className="h-10 w-10" />,
    },
    {
      name: "Natal",
      description: "Ponta Negra, RN",
