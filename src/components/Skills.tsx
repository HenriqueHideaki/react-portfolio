...
export default function Skills() {
  const educations = [
    {
      name: "Engenharia da Computação | UFRN | Em Andamento",
    },
    {
      name: "Bacharelado Interdisciplinar em Ciências e Tecnologia | UFRN",
    },
  ]
      ...
      <div className="container mx-auto max-w-4xl p-4 py-12">
        <div className="relative mb-4 p-4 text-center">
          ...
          <p className="relative text-sm text-gray-700">
            Back-End Developer | Python | Django | Django Rest Framework | SQL 
            | JavaScript | Oracle | ETL
          </p>
